...
class ReconciliationGroupExcelExport implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('ReconciliationGroup.ReconciliationGroupExcelExport', ['data' => $data]);
    }
